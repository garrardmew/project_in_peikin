...
#     print(y_list)
    if load_predictor:
        ...
        if k_cross_validation is None:    
            ...
            vTimesCrossValidation(X, y_list, predictor, output_prefix_predictor, k_cross_validation=k_cross_validation, V_times_cv=V_times_cv, random_state=random_state, minimum_val_for_prediction=minimum_val_for_prediction, minimum_val_for_difference=minimum_val_for_difference, unknown_class_name=unknown_class_name, 
                                  dict_group_to_digit=dict_group_to_digit)
...
def crossValidation(X, y_list, predictor, output_prefix_predictor, k_cross_validation, random_state=None, output_path=None, **kargs):
